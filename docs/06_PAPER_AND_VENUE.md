...
| The result generalizes to a genuine distribution shift | Held-out layouts, corruption shifts, and (resources permitting) independently created examples | **Open — Stage 9** |
